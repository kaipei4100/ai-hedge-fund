...
> **Note:** At minimum you need either `OPENAI_API_KEY` or `GROQ_API_KEY` to run the agents, plus `FINANCIAL_DATASETS_API_KEY` for market data. The app will not function without valid API keys.
